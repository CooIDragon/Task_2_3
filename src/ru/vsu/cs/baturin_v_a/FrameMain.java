...
import ru.vsu.cs.baturin_v_a.util.*;
        ...
        buttonLinkedListQueue.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    ...
                    assert array != null;
                    LinkedListQueue<Integer> queue = LinkedListQueueUtils.intArrayToList(array);

                    BubbleSort bubbleSort = new BubbleSort();
                    bubbleSort.sort(queue);

                    int[] resultArray = LinkedListQueueUtils.intListToArray(queue);
        ...
        buttonStandardQueue.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    ...
                    int[] array = JTableUtils.readIntArrayFromJTable(tableInput);
                    assert array != null;
                    LinkedBlockingQueue<Integer> queue = LinkedBlockedQueueUtils.intArrayToList(array);

                    BubbleSort bubbleSort = new BubbleSort();
                    bubbleSort.sort(queue);

                    int[] resultArray = LinkedBlockedQueueUtils.intListToArray(queue);
                    JTableUtils.writeArrayToJTable(tableOutput, resultArray);
                } catch (Exception e) {
                    SwingUtils.showErrorMessageBox(e);
                }
